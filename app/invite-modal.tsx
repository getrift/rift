  ...
  return (
    <AnimatePresence>
      {open && (
        ...
        >
          <div aria-hidden onClick={onClose} className="absolute inset-0 bg-[#040506]/[0.72] backdrop-blur-md" />
          ...
          <motion.div
            ...
            tabIndex={-1}
            className="relative max-h-[calc(100dvh-2rem)] w-full max-w-[500px] overflow-y-auto rounded-[20px] border border-white/[0.1] bg-panel p-8 shadow-[0_40px_120px_-30px_rgba(0,0,0,0.92)] focus:outline-none sm:p-9"
          ...
          >
            <button
              ...
              onClick={onClose}
              aria-label="Close"
              className="absolute right-5 top-5 flex h-7 w-7 items-center justify-center rounded-full text-ink-faint transition-colors hover:bg-white/[0.06] hover:text-ink-muted"
            >
            ...
            {status === "success" ? (
              <div className="flex flex-col items-center text-center">
                <span className="flex h-12 w-12 items-center justify-center rounded-full border border-white/[0.14] bg-white/[0.04] text-ink">
                  <RiftMark size={22} />
                </span>
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="mt-5 inline-flex h-[40px] items-center rounded-[10px] border border-white/[0.1] bg-white/[0.04] px-4 text-[13.5px] font-medium text-ink-bright transition-[background-color,color,transform] duration-150 hover:bg-white/[0.07] hover:text-ink active:scale-[0.97]"
                >
                  Close
                </button>
              </div>
              ...
              <>
                ...
                <h2 className="mt-6 text-[21px] font-semibold tracking-tight text-ink">Get the Mac installer</h2>
                <p className="mt-3 text-[14.5px] leading-[23px] text-ink-subtle">
                ...
                <form onSubmit={submit} className="mt-8" noValidate>
                  ...
                  <input
                    ...
                    className="h-[50px] w-full rounded-[12px] border border-white/[0.12] bg-white/[0.03] px-4 text-[15px] text-ink outline-none transition-[border-color,box-shadow,background-color] duration-200 placeholder:text-ink-dim focus:border-white/[0.24] focus:bg-white/[0.05] focus:shadow-[0_0_0_3px_rgba(255,255,255,0.06)] focus-visible:outline-none"
                  />
                  {status === "error" && (
                    <p id="invite-error" role="alert" aria-live="assertive" className="mt-2 text-[13px] text-danger">
                      {error}
                    </p>
                  )}
                  ...
                  <button
                    ...
                    className="mt-4 inline-flex h-[50px] w-full items-center justify-center rounded-[12px] bg-ink text-[15px] font-semibold text-canvas transition-[transform,opacity] duration-150 hover:-translate-y-px active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-70"
                  >
